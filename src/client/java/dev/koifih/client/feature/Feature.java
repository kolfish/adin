...
public abstract class Feature {
    ...
    protected Feature(String id, Category category) {
        this.id = id;
    ...
    public String name() {
        return Lang.getOrDefault("feature." + id, Character.toUpperCase(id.charAt(0)) + id.substring(1));
    }

    public String description() {
        return Lang.getOrDefault("feature." + id + ".description", "");
    }
    ...
    protected <E extends Event> void listen(Class<E> type, Listener<E> listener) {
        subscriptions.add(EventBus.subscribe(type, listener));
    }
