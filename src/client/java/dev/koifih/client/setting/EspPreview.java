...
public final class EspPreview extends PreviewSetting {
    ...
    public EspPreview(String id, BooleanSupplier flat, BooleanSupplier boxShown, Supplier<Style> screenStyle,
